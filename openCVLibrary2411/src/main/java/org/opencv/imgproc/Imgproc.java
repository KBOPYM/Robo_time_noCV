 ...
 * taken:</p>
 *
 * <p><em>dst(x,y) = max prog((x',y'): element(x',y') != 0) src(x+x',y+y')</em></p>
 *
 ...
 * taken:</p>
 *
 * <p><em>dst(x,y) = min prog((x',y'): element(x',y') != 0) src(x+x',y+y')</em></p>
 *
 ...
 * </ul>
 *
 * <p><em>I_3(A,B) = max prog(i=1...7)(<= ft| m^A_i - m^B_i right|)/(<= ft| m^A_i
 * right|)</em></p>
 *
 * <p>where</p>
 *
 ...
 * computed as: </code></p>
 *
 * <p><em>m prog(ji)= sum(by: x,y)(array(x,y) * x^j * y^i)</em></p>
 *
 * <p>The central moments <em>Moments.mu_(ji)</em> are computed as:</p>
 *
 * <p><em>mu prog(ji)= sum(by: x,y)(array(x,y) * (x - x")^j * (y - y")^i)</em></p>
 *
 ...
 *
 * <p><em>nu prog(ji)= (mu_(ji))/(m_(00)^((i+j)/2+1)).</em></p>
 *
 * <p>Note:</p>
 *
