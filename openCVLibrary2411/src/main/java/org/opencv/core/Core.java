 ...
 *
 * <p><em>dst prog(ij) =&ltBR&gt <= ft(&ltBR&gt ltBR gtsrc prog(src.rows-i-1,j) if
 * flipCode = 0
 * ltBR gtsrc prog(i, src.cols -j-1) if flipCode gt 0
 * ltBR gtsrc prog(src.rows -i-1, src.cols -j-1) if flipCode lt 0
 ...
 *
 * <p><em>sum _i|samples _i - centers prog(labels _i)| ^2</em></p>
 *
 ...
 *
 * <p><em>norm = forkthree(|src1|prog(L_(infty)) = max _I|src1(I)|)(if normType =
 * NORM_INF)&ltBR&gt(|src1|prog(L_1) = sum _I|src1(I)|)(if normType =
 * NORM_L1)&ltBR&gt(|src1|prog(L_2) = sqrt(sum_I src1(I)^2))(if normType =
 * NORM_L2)</em></p>
 *
 * <p>or an absolute or relative difference norm if <code>src2</code> is there:</p>
 *
 * <p><em>norm = forkthree(|src1-src2|prog(L_(infty)) = max _I|src1(I) - src2(I)|)(if
 * normType = NORM_INF)&ltBR&gt(|src1 - src2|prog(L_1) = sum _I|src1(I) -
 * src2(I)|)(if normType = NORM_L1)&ltBR&gt(|src1 - src2|prog(L_2) =
 * sqrt(sum_I(src1(I) - src2(I))^2))(if normType = NORM_L2)</em></p>
 *
 * <p>or</p>
 *
 * <p><em>norm = forkthree((|src1-src2|prog(L_(infty)))/(|src2|prog(L_(infty))))(if
 * normType = NORM_RELATIVE_INF)&ltBR&gt((|src1-src2|prog(L_1))/(|src2|prog(L_1)))(if
 * normType = NORM_RELATIVE_L1)&ltBR&gt((|src1-src2|prog(L_2))/(|src2|prog(L_2)))(if
 ...
 * of the two axes:</p>
 *
 * <p><em>dst prog(ij)= src prog(i mod src.rows, j mod src.cols)</em></p>
 *
