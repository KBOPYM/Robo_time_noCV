package io.github.RoboTime.rectangledetection.utils;
...
import io.github.RoboTime.rectangledetection.models.MatData;
    ...
    public static Observable<MatData> getPath(MatData matData) {
        return Observable.create(subscriber -> {
            ...
            if (matData.points != null && matData.points.size() == 4) {
                ...
                Log.v(TAG, "____Drawing CV here" + (float)cameraPoints.get(0).x + " " + (float)cameraPoints.get(0).y);
